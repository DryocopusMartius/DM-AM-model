...
to setup-caves
  set initial-number-caves round (number-bwps * 9.3 - number-bwps ^ 2 * 0.42)                   ;the initial number of caves are calculated using parameters from a prior fitted
                                                                                                ...
                                                                                                ;(data used: Zahner et al, 2017; Abs et al, 1980; Hoffmann, 2005; Müller, 2013)
...
to setup-date
  create-dates 1 [                                                                             ;date agent is placed in upper right; because sim starts with beginning of the year
    set size 5
    set color black
    set shape "m-jan"                                                                          ;first shape is January
    setxy 22 23
  ]
end
...
to go                                                                                          ;main go
  proceed-date
  (ifelse
    ticks mod 12 = 0 [kill-bees]                                                               ;January: bees die of freezing
    ...
    ticks mod 12 = 9 [weather]                                                                 ;October: Caves weather
